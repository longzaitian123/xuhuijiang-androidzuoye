...
import com.example.zuoye9.fragment.BookDetailFragment;
import com.example.zuoye9.fragment.BookCoverFragment;
import com.example.zuoye9.fragment.BooktjlFragment;
import com.example.zuoye9.fragment.BooktpjFragment;
...
public class GoodsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) { // 第一页展示书籍封面
            ...
            return new BooktjlFragment();
        } else if (position == 3) { // 第二页展示书籍详情
            return new BooktpjFragment();
        }
        return new BookCoverFragment();
    }
