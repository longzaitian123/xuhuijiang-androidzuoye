...
public class TabHostActivity extends TabActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_second.setOnClickListener(this); // 给第二个标签注册点击监听器
        ...
        tab_host.addTab(getNewTab(FIRST_TAG, R.string.menu_first, R.drawable.tab_first_selector, ShoppingFirstActivity.class));
        ...
        tab_host.addTab(getNewTab(SECOND_TAG, R.string.menu_second, R.drawable.tab_second_selector, ShoppingChannelActivity.class));

        // 往标签栏添加第三个标签，其中内容视图展示TabThirdActivity
        tab_host.addTab(getNewTab(THIRD_TAG, R.string.menu_third, R.drawable.tab_third_selector, ShoppingCartProActivity.class));
